...
/// 12 x 12 blue square body with a white cross-slot knob.
pub fn trimmer_potentiometer() -> PixelCanvas {
...
/// 12 x 12 round orange-red disc with a zigzag track, like a photoresistor.
pub fn photoresistor() -> PixelCanvas {
    let mut canvas = PixelCanvas::new(12, 12);
    ...
    // A zigzag conductive track across the middle.
    for (x, y) in [
        (2, 6),
        (3, 4),
        (4, 6),
